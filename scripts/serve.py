...
self-signed certificate made on first use (web/tls/, ignored by git). Microphones, cameras and
iroh's relay probes need a secure context, so anything but localhost wants --https; the browser
will warn about the certificate once."""
